...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_US_DEF_] = LAYOUT_universal(
    ...
    KC_ESC, XXXXXXX, XXXXXXX, LT(_FUNC_,KC_TAB), LT(_US_SYM_,KC_SPC), CTL_T(KC_ENT),    LT(_FUNC_,KC_BSPC), KC_RSFT, XXXXXXX, XXXXXXX   , XXXXXXX    , KC_DEL
  ),

  [_US_SYM_] = LAYOUT_universal(
    KC_1       , KC_2       , KC_3       , KC_4       , KC_5       ,                              KC_6       , KC_7       , KC_8       , KC_9       , KC_0       ,
    KC_INS     , KC_HOME    , KC_UP      , KC_END     , KC_PGUP    ,                              KC_LANGUAGE_2, KC_GRV     , KC_EQL     , KC_SCLN    , KC_QUOT    ,
    GUI_T(KC_PSCR), ALT_T(KC_LEFT), CTL_T(KC_DOWN), SFT_T(KC_RGHT), KC_PGDN,                      KC_LANGUAGE_1, KC_LSFT, CTL_T(KC_LBRC), ALT_T(KC_RBRC), GUI_T(KC_BSLS),
