...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_US_DEF_] = LAYOUT_universal(
    ...
    KC_LGUI, KC_LCTL, KC_LALT, LT(_US_FNC_,KC_DEL), LT(_US_SYM_,KC_SPC), SFT_T(KC_TAB), SFT_T(KC_BSPC), LT(_US_SYM_,KC_ENT), XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL
  ),
  ...
  [_US_SYM_] = LAYOUT_universal(
    ...
    KC_LGUI, KC_LCTL, KC_LALT, LT(_US_FNC_,KC_DEL), SFT_T(KC_SPC), SFT_T(KC_TAB),   SFT_T(KC_BSPC), SFT_T(KC_ENT), XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL
  ),
  ...
  [_US_FNC_] = LAYOUT_universal(
    ...
    KC_LGUI   , KC_LCTL   , KC_LALT   , XXXXXXX   , SFT_T(KC_SPC), SFT_T(KC_TAB),   SFT_T(KC_BSPC), SFT_T(KC_ENT), XXXXXXX   , XXXXXXX   , XXXXXXX   , KC_DEL
  ),
