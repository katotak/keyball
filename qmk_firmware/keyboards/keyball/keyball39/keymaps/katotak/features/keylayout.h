...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_US_SYM_] = LAYOUT_universal(
    ...
    GUI_T(KC_PSCR), SFT_T(KC_LEFT), CTL_T(KC_DOWN), ALT_T(KC_RGHT), KC_PGDN,                      DF(_JP_DEF_), KC_LALT, CTL_T(KC_LBRC), SFT_T(KC_RBRC), GUI_T(KC_BSLS),
  ...
  [_JP_SYM_] = LAYOUT_universal(
    KC_1       , KC_2       , KC_3       , KC_4       , KC_5       ,                              KC_6       , KC_7       , KC_8       , KC_9       , KC_0       ,
    KC_INS     , KC_HOME    , KC_UP      , KC_END     , KC_PGUP    ,                              XXXXXXX, KC_GRV     , KC_EQL     , KC_QUOT    , KC_SCLN    ,
    GUI_T(KC_PSCR), SFT_T(KC_LEFT), CTL_T(KC_DOWN), ALT_T(KC_RGHT), KC_PGDN,                      DF(_US_DEF_), KC_LALT, CTL_T(KC_LBRC), SFT_T(KC_RBRC), GUI_T(KC_BSLS),
    _______    , _______    , _______    , _______    , _______    , _______    ,    _______    , _______    , _______    , _______    , _______    , _______
  ),
