...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_US_SYM_] = LAYOUT_universal(
    ...
    KC_INS     , KC_HOME    , KC_UP      , KC_END     , KC_PGUP    ,                              ORG_RAR     , KC_GRV     , KC_EQL     , KC_QUOT    , KC_SCLN    ,
    GUI_T(KC_PSCR), SFT_T(KC_LEFT), CTL_T(KC_DOWN), ALT_T(KC_RGHT), KC_PGDN,                      ORG_LAR, KC_LALT, CTL_T(KC_LBRC), SFT_T(KC_RBRC), GUI_T(KC_BSLS),
