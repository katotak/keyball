...
const key_override_t kc_rbrc_to_jp_rbrc     = ko_make_with_layers_and_negmods(0, ALT_T(KC_RBRC), JP_RBRC, (1<<_JP_DEF_ | 1<<_JP_SYM_), (uint8_t) MOD_MASK_SHIFT);
const key_override_t sft_kc_rbrc_to_jp_rcbr     = ko_make_with_layers(MOD_MASK_SHIFT, ALT_T(KC_RBRC), JP_RCBR, (1<<_JP_DEF_ | 1<<_JP_SYM_));
