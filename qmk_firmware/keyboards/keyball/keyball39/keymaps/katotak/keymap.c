...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [US_DEF] = LAYOUT_universal(
    ...
    KC_A      , KC_S      , KC_D      , KC_F      , KC_G      ,                              KC_H      , KC_J      , KC_K      , KC_L      , LT(SCRL,KC_MINS)   ,
    KC_Z , SFT_T(KC_X) , CTL_T(KC_C) , ALT_T(KC_V), KC_B      ,                              KC_N, ALT_T(KC_M), CTL_T(KC_COMM), SFT_T(KC_DOT), KC_SLSH ,
    LALT_T(KC_ESC), KC_LCTL, KC_LGUI, KC_TAB    , LT(US_SYM,KC_SPC), KC_LSFT,            KC_BSPC, LT(US_NUM,KC_ENT) , XXXXXXX , XXXXXXX  , XXXXXXX   , A(KC_GRV)
  ),

  [US_SYM] = LAYOUT_universal(
    ...
    _______  , _______  , _______  , _______  , LT(FUNC,_______) , _______   ,      _______   , LT(FUNC,_______), _______  , _______  , _______  , _______
  ),

  [US_NUM] = LAYOUT_universal(
    KC_1      , KC_2      , KC_3      , KC_4      , KC_5      ,                              KC_6      , KC_7      , KC_8      , KC_9      , KC_0      ,
    KC_HOME   , KC_PGUP   , KC_UP     , KC_PGDN   , KC_DEL    ,                              KC_BTN4   , KC_BTN1   , KC_BTN3   , KC_BTN2   , KC_BTN5   ,
    KC_END    , KC_LEFT   , KC_DOWN   , KC_RGHT   , KC_INS    ,                              DF(JP_DEF)  ,ALT_T(XXXXXXX),CTL_T(XXXXXXX),SFT_T(XXXXXXX),XXXXXXX,
    _______  , _______  , _______  , _______  , LT(FUNC,_______) , _______   ,      _______   , LT(FUNC,_______), _______  , _______  , _______  , _______
  ),
  ...
  [JP_DEF] = LAYOUT_universal(
    ...
    KC_A      , KC_S      , KC_D      , KC_F      , KC_G      ,                              KC_H      , KC_J      , KC_K      , KC_L      , LT(SCRL,KC_MINS)   ,
    KC_Z , SFT_T(KC_X) , CTL_T(KC_C) , ALT_T(KC_V), KC_B      ,                              KC_N, ALT_T(KC_M), CTL_T(KC_COMM), SFT_T(KC_DOT), KC_SLSH ,
    LALT_T(KC_ESC), KC_LCTL, KC_LGUI, KC_TAB    , LT(JP_SYM,KC_SPC), KC_LSFT,            KC_BSPC, LT(JP_NUM,KC_ENT) , XXXXXXX , XXXXXXX  , XXXXXXX   , KC_GRV
  ),

  [JP_SYM] = LAYOUT_universal(
  ...
  [JP_NUM] = LAYOUT_universal(
    KC_1      , KC_2      , KC_3      , KC_4      , KC_5      ,                              KC_6      , KC_7      , KC_8      , KC_9      , KC_0      ,
    KC_HOME   , KC_PGUP   , KC_UP     , KC_PGDN   , KC_DEL    ,                              KC_BTN4   , KC_BTN1   , KC_BTN3   , KC_BTN2   , KC_BTN5   ,
    KC_END    , KC_LEFT   , KC_DOWN   , KC_RGHT   , KC_INS    ,                              DF(US_DEF)  ,ALT_T(XXXXXXX),CTL_T(XXXXXXX),SFT_T(XXXXXXX),XXXXXXX,
    _______  , _______  , _______  , _______  , LT(FUNC,_______) , _______   ,      _______   , LT(XXXXXXX,_______), _______  , _______  , _______  , _______
  ),
