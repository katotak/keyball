...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_universal(
    ...
    LALT_T(KC_ESC), KC_LGUI, KC_LCTL, KC_TAB    , LT(1,KC_SPC), KC_LSFT,            KC_BSPC, LT(2,KC_ENT) , XXXXXXX , XXXXXXX  , XXXXXXX   , A(KC_GRV)
  ),
  ...
  LAYOUT_universal(
    ...
    KC_HOME   , KC_PGUP   , KC_UP     , KC_PGDN   , KC_INS    ,                        KC_TO_CLICKABLE_INC, KC_MY_BTN1, KC_MY_BTN3, KC_MY_BTN2, KC_MY_SCR ,
    KC_END    , KC_LEFT   , KC_DOWN   , KC_RGHT   , KC_DEL    ,                        KC_TO_CLICKABLE_DEC,ALT_T(KC_BTN4),CTL_T(XXXXXXX),SFT_T(KC_BTN5),XXXXXXX,
    _______  , _______  , _______  , _______  , LT(3,_______) , _______   ,      _______   , LT(3,_______), _______  , _______  , _______  , _______
  ),
  ...
  LAYOUT_universal(
    ...
    XXXXXXX,ALT_T(XXXXXXX),CTL_T(XXXXXXX),SFT_T(XXXXXXX),XXXXXXX,                            XXXXXXX,ALT_T(XXXXXXX),CTL_T(XXXXXXX),SFT_T(XXXXXXX),XXXXXXX,
    _______   , _______   , _______   , _______   , _______   , _______   ,      _______   , _______   , _______   , _______   , _______   , _______
  ),

  LAYOUT_universal(
    XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,                              XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,
    XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,                              XXXXXXX   , KC_MY_BTN1, KC_MY_BTN3, KC_MY_BTN2, KC_MY_SCR ,
    XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,                              XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   , XXXXXXX   ,
    _______   , _______   , _______   , _______   , _______   , _______   ,      _______   , _______   , _______   , _______   , _______   , _______
  )
};