...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_US_DEF_] = LAYOUT_universal(
    ...
    KC_LBRC  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                  KC_H     , KC_J     , KC_K     , LT(_NUM_SCR_,KC_L), KC_MINS  , KC_QUOT  ,
  ...
  [_JP_DEF_] = LAYOUT_universal(
    ...
    JP_LBRC  , JP_A     , JP_S     , JP_D     , JP_F     , JP_G     ,                                  JP_H     , JP_J     , JP_K     , LT(_NUM_SCR_,KC_L), JP_MINS  , JP_QUOT  ,
  ...
  [_NUM_SCR_] = LAYOUT_universal(
    ...
    XXXXXXX  , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     ,                                  KC_HOME  , KC_PGUP  , KC_UP    , KC_PGDN  , KC_F11   , XXXXXXX  ,
    XXXXXXX  , KC_6    , SFT_T(KC_7), CTL_T(KC_8), ALT_T(KC_9), KC_0, DF(_JP_DEF_),          DF(_US_DEF_), KC_END , KC_LEFT  , KC_DOWN  , KC_RGHT  , KC_F12   , XXXXXXX  ,
    _______  , _______  , _______  , _______  , _______  , _______  , KC_DEL   ,             _______   , _______  , XXXXXXX  , XXXXXXX  , XXXXXXX  , _______  , _______
  )
